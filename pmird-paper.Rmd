...
1.  The recalibration of C and N content data and $\delta^{13}$C and $\delta^{15}$N values using the R package 'elco' [@Teickner.2020b] --- in the case where raw data were available. This calibration does not account for so-called blank effects [@Langel.2017] and therefore the isotope values may be biased (depending on the C or N content and the mass of the sample). Correcting blank effects was not possible because no appropriate correction models could be constructed due to lack of sufficient standard measurements.  
