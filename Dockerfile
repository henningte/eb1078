...
# docker build -t eb1078:0.0.0.9000 .

# to run the image in a container, do:
# docker run --name eb1078_c -e PASSWORD=eb1078 --net r-db -p 8795:8787 -v $(pwd):/home/rstudio/eb1078 eb1078:0.0.0.9000

# to reproduce the analyses from all projects, run (takes about 20 h and occupies additional 50 Gb disk space)
# docker run --rm -v $(pwd):/home/rstudio eb1078:0.0.0.9000 R -e 'setwd("/home/rstudio/eb1078");
#
